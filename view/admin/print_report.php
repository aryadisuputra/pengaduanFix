  ...
  <div id="wrapper">
        ...
        <div class="mt-4 container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <button onclick="window.print();" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm d-print-none"><i class="fas fa-print fa-sm text-white-50 d-print-none"></i> Cetak Laporan</button>
          </div>
